...
AI-powered Instagram carousel & post builder. Next.js 16 + React 19 + TypeScript + Tailwind v4.

A re-skinned fork of [open-carrusel](https://github.com/Hainrixz/open-carrusel) — dark theme, violet accent, designed as an educational repository for students to clone, run locally and extend.
